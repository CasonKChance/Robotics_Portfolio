#include <project_3_ros_unicycle_robot_sim_2d_v2/Robot.h>
...
void Robot::updateActualVelocity(double dt)
{
  ...
  actualVelocity_.linearVelocity = std::clamp(actualVelocity_.linearVelocity,
    -maximumLinearVelocity_, maximumLinearVelocity_);
  actualVelocity_.angularVelocity = std::clamp(actualVelocity_.angularVelocity,
    -maximumAngularVelocity_, maximumAngularVelocity_);
}
